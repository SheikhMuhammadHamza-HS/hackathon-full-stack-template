 ...
 * - Server-side error handling (duplicate emails, etc.)
...
/**
 * Signup page component with modern UI design
 */
export default function SignupPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (errorMessage.toLowerCase().includes('admin person')) {
        setErrors({ email: 'This email is used by admin person. Please signup with a different email.' });
  ...
  return (
    <AuthForm
      ...
      description="Join our platform to start managing your tasks efficiently"
